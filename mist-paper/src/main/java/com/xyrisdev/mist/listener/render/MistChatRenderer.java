...
public final class MistChatRenderer {
	...
	public static @NotNull ChatRenderer renderer(@NotNull ChatContext ctx) {
		return (player, displayName, message, audience) -> render(ctx, player, displayName, message);
	}

	public static @NotNull Component render(@NotNull ChatContext ctx, @NotNull Player player, @NotNull Component displayName, @NotNull Component message) {
